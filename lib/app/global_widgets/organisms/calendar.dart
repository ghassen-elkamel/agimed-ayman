...
// import '../../core/extensions/date/compare_dates.dart';
// import '../../core/extensions/string/capitalize_first_letter.dart';
...
//             eventLoader: (day) => events.where((element) => element.date.isEqualDate(day)).toList(),
...
//             child: Divider(),
//           ),
//           ...events.where((element) => element.date.isEqualDate(selectedDay)).map(
//                 (event) => InkWell(
