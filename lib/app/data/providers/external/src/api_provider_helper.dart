...
extension Helper on ApiProvider {
  ...
  Map<String, String> getHeaders(HttpParams params) {
    ...
    return <String, String>{
      ...
      if (AuthService.access?.companyCode != null)
        'companyCode': AuthService.access!.companyCode!.toString(),
      if (AuthService.selectedClassCode != null)
        'classCode': AuthService.selectedClassCode.toString(),
      'language': LanguageHelper.language ?? 'ar',
      'app-src': 'Tfc',
    };
  }
